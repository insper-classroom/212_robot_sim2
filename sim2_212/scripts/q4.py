...
COR_MENOR_LISTA = [COR_MENOR_MAGENTA, COR_MENOR_VERDE, COR_MENOR_AZUL, COR_MENOR_AMARELO]
COR_MAIOR_LISTA = [COR_MAIOR_MAGENTA, COR_MAIOR_VERDE, COR_MAIOR_AZUL, COR_MAIOR_AMARELO]
...
class Estados:
    ...
    def __init__(self):
        ...
        self.estado = ESTADO_LIBERA_CAIXA
        self.indice_cor = 0
    ...
    def procura_cor(self):
        ...
        now = time.time()
        lag = now - self.ultimo_tempo
        
        if lag > 20:
            return ESTADO_LIBERA_CAIXA
        ...
        if cv_image is not None:
            ...
            if maior_contorno_area > 0 :
                if abs(media[0] - centro[0]) > 20:
                    ...
                    vel = Twist(Vector3(0,0,0), Vector3(0,0,-erro/400))
                    velocidade_saida.publish(vel)
